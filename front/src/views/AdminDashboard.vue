<template>
  <div class="min-h-screen w-full bg-cover bg-center bg-fixed shadow-sm border-t-[0.1%] border-l-[0.1%] border-[#000000] rounded-tl-[2%] pl-[0.5%] pr-[0.5%] xl:pl-[0.9%] xl:pr-[0.9%]" :style="{ backgroundImage: 'url(/src/assets/bg-dashboard.jpeg)' }">
    ...
    <div class="flex flex-col items-start space-y-8 h-full">
      ...
      <div :class="['ml-8 mt-8 p-4 w-2/3 sm:w-1/2 lg:w-1/4 xl:w-1/5 rounded-lg shadow-md', isDarkTheme ? 'bg-InputBgGray text-white' : 'bg-white text-black']">
      ...
      <div class="flex flex-col space-y-8 w-full h-full">
        <div class="flex items-start h-full">
          ...
          <div class="flex-grow">
            <h1 :class="['text-2xl font-poppins font-medium', isDarkTheme ? 'text-white' : 'text-black']">Charts</h1>
            <ChartManager />
          </div>
        </div>
        ...
        <div class="flex items-start h-full">
          ...
          <div class="flex-grow">
            <h1 :class="['text-2xl font-poppins font-medium', isDarkTheme ? 'text-white' : 'text-black']">TimeManager</h1>
            <WorkingTimes />
          </div>
        </div>
      </div>
